...
This repository contains the complete configuration for Luna's development and automation environment, who is Matthieu's AI agent (a useful assistant). But there's also Claude, OpenCode, Copilot, Codex, Ralph and all the others.
...
ssh-keygen -t ed25519 -C "luna@boxydev.com"
cat /home/luna/.ssh/id_ed25519.pub
...
ssh -R 9222:127.0.0.1:9222 -N luna@vps
```
